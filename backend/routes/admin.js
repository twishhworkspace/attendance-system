...
const { getAllLeaveRequests, processLeaveRequest } = require('../controllers/leaveController');
...
router.get('/status-employees/:status', getStatusEmployees);
...
router.get('/requests/leave', getAllLeaveRequests);
router.post('/requests/leave/:id/process', processLeaveRequest);
