...
export const useAutoLogout = (timeoutMs = 60000) => {
    ...
    useEffect(() => {
        // Disengaged: Employees stay logged in for a month and are no longer logged out due to inactivity.
        // Session duration is managed securely by backend JWT and cookie expiration policies (30 days).
        return;
