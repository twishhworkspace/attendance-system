...
const GlobalSidebar = ({ user, view, setView, onLogout, isOpen, setIsOpen }) => {
    ...
    const menuItems = isSuper ? [
        ...
        { id: 'admin-expenses', label: 'Expense Auditor', icon: CircleDollarSign },
        { id: 'spatial-intel', label: 'Office Location', icon: Map },
        ...
        ...(user.expenseEnabled ? [{ id: 'expenses', label: 'Expense Tracker', icon: CircleDollarSign }] : []),
