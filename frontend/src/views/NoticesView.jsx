                ...
                {loading ? (
                    ...
                    notices.map(notice => (
                        <div key={notice.id} className={`glass-panel p-8 border-l-4 group relative transition-all hover:scale-[1.01] ${
                            ...
                            <p className="text-[13px] font-medium text-slate-300 leading-relaxed mb-8 bg-white/5 p-6 rounded-2xl border border-white/5 whitespace-pre-wrap">
                                {notice.message}
                            </p>
                            ...
                            <div className="flex items-center justify-between pt-6 border-t border-white/5">
                                ...
                                {notice.scheduledDate && (
                                    <div className="flex items-center gap-2 px-3 py-1 bg-emerald-500/10 text-emerald-500 rounded-lg">
                                        <Calendar size={12} />
                                        <span className="text-[9px] font-black uppercase tracking-tighter">
                                            Event Date: {new Date(notice.scheduledDate).toLocaleDateString('en-GB')}
                                        </span>
                                    </div>
                                )}
                            </div>
